import { Trophy, Users, GraduationCap, Stethoscope, BadgeCheck } from "lucide-react";

const stats = [
  { Icon: Trophy,        num: "9+",        numColor: "#fde68a", lbl: "Years of Excellence" },
  { Icon: Users,         num: "40",        numColor: "#fff",    lbl: "Students Per Batch" },
  { Icon: GraduationCap, num: "IIT & NIT", numColor: "#fff",    lbl: "Engineering Selections" },
  { Icon: Stethoscope,   num: "MBBS",      numColor: "#fff",    lbl: "Medical Achievers" },
  { Icon: BadgeCheck,    num: "Govt. ✓",   numColor: "#fde68a", lbl: "Recognised · Code 58471" },
];
