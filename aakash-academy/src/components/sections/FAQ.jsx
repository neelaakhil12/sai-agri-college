        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 lg:gap-14">
          ...
          <Reveal>
            ...
            <p className="text-[0.88rem] md:text-[0.9rem] text-muted leading-[1.75] mt-3">
              ...
              <strong><a href="tel:7995551213" className="text-blue no-underline hover:underline">7995551213</a></strong>{" "}
            ...
            <div className="flex flex-col gap-[10px] mt-[6px]">
              {faqs.map((faq, i) => (
                <div key={i} className="bg-white rounded-xl overflow-hidden transition-[border-color] duration-200"
                  style={{ border: `1.5px solid ${open === i ? "#1347a0" : "#e2e8f0"}` }}>
                  <button onClick={() => setOpen(open === i ? -1 : i)}
                    ...
                    {faq.q}
                    <span style={{ transform: open === i ? "rotate(180deg)" : "rotate(0deg)", transition: "transform .3s", color: open === i ? "#1347a0" : "#6b7280" }}>
                      <ChevronDown />
                    </span>
                  </button>
