      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-6 font-sora">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-10 border border-gray-100">
          <div className="text-center mb-8">
             <div className="w-16 h-16 bg-blue rounded-2xl mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-blue/20">A</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <div className="flex items-center gap-3">
               <div className="w-10 h-10 bg-blue rounded-xl flex items-center justify-center text-white font-bold">A</div>
                    ...
                    <>
                      ...
                      <td className="px-8 py-5 text-right">
                        <div className="flex flex-col items-end gap-2">
                          <button 
                            onClick={() => {
                              const text = `*New Enquiry from Aakash Academy*%0A%0A*Student:* ${item.studentName}%0A*Parent:* ${item.parentName}%0A*Mobile:* ${item.mobile}%0A*Stream:* ${item.stream}%0A*Batch:* ${item.batch}%0A*Message:* ${item.message || 'N/A'}`;
