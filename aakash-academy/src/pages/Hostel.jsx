          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              ...
              <p className="text-ink/65 leading-8 text-lg mt-6">
                At SRI Aakash Academy, we understand that a proper living environment is crucial for academic success. Our separate, safe, and purpose-built residential campuses for Boys and Girls provide the perfect foundation for students to focus entirely on their studies without daily commute stress.
              </p>
