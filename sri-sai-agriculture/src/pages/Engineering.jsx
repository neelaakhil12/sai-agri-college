          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <Reveal delay={0.2}>
              ...
              <p className="text-ink/65 text-lg leading-relaxed mb-10">
                At Sri Sai Agri, we understand that a proper environment is crucial for academic success. We provide separate, safe, and purpose-built campuses for boys and girls, featuring on-site hostels and supervised evening study hours.
              </p>
