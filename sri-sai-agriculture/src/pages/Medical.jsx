          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              ...
              <p className="text-ink/65 leading-8 text-lg mt-6">
                The Medical Stream (BiPC) at Sri Sai Agri Academy is meticulously designed for students who aspire to crack NEET and other medical entrance exams. We emphasize a deep understanding of biological concepts, complemented by strong foundations in Physics and Chemistry.
              </p>
