...
export default function FloatingButtons() {
  return (
    <div className="fixed bottom-4 right-3 md:bottom-6 md:right-6 z-[500] flex flex-col gap-2 md:gap-[9px] items-end">
      <a href={`https://wa.me/7550252015?text=${encodeURIComponent("Hi Sri Sai Institute, I would like to enquire about B.Sc/M.Sc Agriculture admissions.")}`}
        target="_blank"
        ...
        style={{ background: "#25D366", boxShadow: "0 6px 22px rgba(37,211,102,.42)" }}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="md:size-[16px]">
      ...
      <a href={`tel:${siteConfig.phones[0]}`}
        className="flex items-center gap-2 md:gap-[9px] text-white px-3 md:px-[18px] py-2 md:py-3
          rounded-full font-bold text-[0.78rem] md:text-[0.87rem] no-underline transition-all duration-200 hover:scale-[1.03]"
        style={{ background: "#dc2626", boxShadow: "0 6px 22px rgba(220,38,38,.42)", animation: "fpulse 3s infinite" }}>
